...
public class SellerDeliveredOrderFragment extends Fragment {

    public SellerDeliveredOrderFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_seller_delivered_order, container, false);
